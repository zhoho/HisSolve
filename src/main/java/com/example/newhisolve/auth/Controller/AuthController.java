...
//        if (user != null) {
//            System.out.println("로그아웃할 사용자: " + user.getUsername());
//            // 로그아웃 시 active 상태를 false로 설정
//            userService.updateUserActiveStatus(user.getUsername(), false);
//            System.out.println("사용자의 active 상태가 false로 업데이트되었습니다.");
//        } else {
